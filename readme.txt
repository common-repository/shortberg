...
You can use the shortcode format `[shortberg id="TEMPLATE_ID"]` to display your template anywhere on your site. Replace `TEMPLATE_ID` with the ID of your template.
