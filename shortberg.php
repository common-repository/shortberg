...
if (!class_exists('ShortBerg')) {
    class ShortBerg {
        ...
        public function __construct() {
            ...
            add_shortcode('shortberg', [$this, 'shortberg_shortcode']);
        ...
        public function shortberg_cpt() {
            $labels = array (
                "name"          => __('Templates', 'shortberg'),
                "singular_name" => __('Template', 'shortberg'),
                "menu_name"     => __('ShortBerg', 'shortberg'),
            ...
            $args = array (
                ...
                "can_export"    => true,
                "menu_position" => 15,
                "menu_icon"     => SHORTBERG_URL . 'assets/icon_menu.png',
        ...
        public function shortberg_shortcode($atts) {
            ...
            $atts = shortcode_atts(['id' => null], $atts, 'shortberg');
        ...
        public function shortberg_add_meta_boxes() {
            add_meta_box('shortberg_meta', esc_html__('Template Shortcode', 'shortberg'), [$this, 'shortberg_render_meta_box'], 'shortberg', 'side', 'default');
        }
        ...
        public function shortberg_wp_scripts() {
            ...
            if (class_exists('ABlocks') && is_main_query() && !is_admin() && has_shortcode($post->post_content, 'shortberg')) {
                // Get all IDs of shortberg posts
                preg_match_all('/\[shortberg id="(\d+)"\]/', $post->post_content, $matches);
        ...
        public function shortberg_custom_column_content($column, $post_id) {
            if ($column == 'shortcode') {
                ...
                $full_shortcode = sprintf('[shortberg id="%s"]', $template_id);
